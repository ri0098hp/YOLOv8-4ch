    ...
    def get_box_metrics(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes):
        if self.roll_out:
            ...
            for b in range(self.bs):
                ...
                overlaps[b] = (
                    bbox_iou(gt_bboxes[b].unsqueeze(1), pd_bboxes[b].unsqueeze(0), xywh=False, CIoU=True)
                    .squeeze(2)
                    .clamp(0)
                )
            ...
            overlaps = (
                bbox_iou(gt_bboxes.unsqueeze(2), pd_bboxes.unsqueeze(1), xywh=False, CIoU=True).squeeze(3).clamp(0)
            )
