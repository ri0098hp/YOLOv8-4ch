...
class AIFI(TransformerEncoderLayer):
    ...
    def build_2d_sincos_position_embedding(w, h, embed_dim=256, temperature=10000.0):
        ...
        return torch.concat([torch.sin(out_w), torch.cos(out_w), torch.sin(out_h), torch.cos(out_h)], axis=1)[
            None, :, :
        ]
...
class DeformableTransformerDecoderLayer(nn.Module):
    ...
    def forward(
        self, tgt, reference_points, src, src_spatial_shapes, src_padding_mask=None, attn_mask=None, query_pos=None
    ):
        # self attention
        ...
        tgt2 = self.cross_attn(
            self.with_pos_embed(tgt, query_pos), reference_points, src, src_spatial_shapes, src_padding_mask
        )
...
class DeformableTransformerDecoder(nn.Module):
    ...
    def forward(
        ...
        for i, layer in enumerate(self.layers):
            ...
            output = layer(
                output, ref_points_input, src, src_spatial_shapes, src_padding_mask, attn_mask, query_pos_embed
            )
